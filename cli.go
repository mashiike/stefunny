...
type CLI struct {
	...
	TFState  string   `name:"tfstate" help:"URL to terraform.tfstate referenced in config" default:"terraform.tfstate" env:"STEFUNNY_TFSTATE" json:"tfstate,omitempty"`
	...
	Region   string   `name:"region" help:"AWS region" default:"" env:"AWS_REGION" json:"region,omitempty"`
